...
def password_health(request):
    ...
    return render(request, 'webapp/password-health.html', context=context)


# - Encrypt Passwords 
@login_required(login_url='my-login')
def password_encrypt(request):

    my_records = Record.objects.all()

    context = {'records': my_records}

    return render(request, 'webapp/password-encrypt.html', context=context)
